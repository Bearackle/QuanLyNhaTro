...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new view.CustomControl.DatePicker.Button();
        cmdTu = new view.CustomControl.DatePicker.Button();
        cmdWe = new view.CustomControl.DatePicker.Button();
        cmdTh = new view.CustomControl.DatePicker.Button();
        cmdFr = new view.CustomControl.DatePicker.Button();
        cmdSa = new view.CustomControl.DatePicker.Button();
        cmdSu = new view.CustomControl.DatePicker.Button();
        cmd1 = new view.CustomControl.DatePicker.Button();
        cmd2 = new view.CustomControl.DatePicker.Button();
        cmd3 = new view.CustomControl.DatePicker.Button();
        cmd4 = new view.CustomControl.DatePicker.Button();
        cmd5 = new view.CustomControl.DatePicker.Button();
        cmd6 = new view.CustomControl.DatePicker.Button();
        cmd7 = new view.CustomControl.DatePicker.Button();
        cmd8 = new view.CustomControl.DatePicker.Button();
        cmd9 = new view.CustomControl.DatePicker.Button();
        cmd10 = new view.CustomControl.DatePicker.Button();
        cmd11 = new view.CustomControl.DatePicker.Button();
        cmd12 = new view.CustomControl.DatePicker.Button();
        cmd13 = new view.CustomControl.DatePicker.Button();
        cmd14 = new view.CustomControl.DatePicker.Button();
        cmd15 = new view.CustomControl.DatePicker.Button();
        cmd16 = new view.CustomControl.DatePicker.Button();
        cmd17 = new view.CustomControl.DatePicker.Button();
        cmd18 = new view.CustomControl.DatePicker.Button();
        cmd19 = new view.CustomControl.DatePicker.Button();
        cmd20 = new view.CustomControl.DatePicker.Button();
        cmd21 = new view.CustomControl.DatePicker.Button();
        cmd22 = new view.CustomControl.DatePicker.Button();
        cmd23 = new view.CustomControl.DatePicker.Button();
        cmd24 = new view.CustomControl.DatePicker.Button();
        cmd25 = new view.CustomControl.DatePicker.Button();
        cmd26 = new view.CustomControl.DatePicker.Button();
        cmd27 = new view.CustomControl.DatePicker.Button();
        cmd28 = new view.CustomControl.DatePicker.Button();
        cmd29 = new view.CustomControl.DatePicker.Button();
        cmd30 = new view.CustomControl.DatePicker.Button();
        cmd31 = new view.CustomControl.DatePicker.Button();
        cmd32 = new view.CustomControl.DatePicker.Button();
        cmd33 = new view.CustomControl.DatePicker.Button();
        cmd34 = new view.CustomControl.DatePicker.Button();
        cmd35 = new view.CustomControl.DatePicker.Button();
        cmd36 = new view.CustomControl.DatePicker.Button();
        cmd37 = new view.CustomControl.DatePicker.Button();
        cmd38 = new view.CustomControl.DatePicker.Button();
        cmd39 = new view.CustomControl.DatePicker.Button();
        cmd40 = new view.CustomControl.DatePicker.Button();
        cmd41 = new view.CustomControl.DatePicker.Button();
        cmd42 = new view.CustomControl.DatePicker.Button();
    ...
    private view.CustomControl.DatePicker.Button cmd1;
    private view.CustomControl.DatePicker.Button cmd10;
    private view.CustomControl.DatePicker.Button cmd11;
    private view.CustomControl.DatePicker.Button cmd12;
    private view.CustomControl.DatePicker.Button cmd13;
    private view.CustomControl.DatePicker.Button cmd14;
    private view.CustomControl.DatePicker.Button cmd15;
    private view.CustomControl.DatePicker.Button cmd16;
    private view.CustomControl.DatePicker.Button cmd17;
    private view.CustomControl.DatePicker.Button cmd18;
    private view.CustomControl.DatePicker.Button cmd19;
    private view.CustomControl.DatePicker.Button cmd2;
    private view.CustomControl.DatePicker.Button cmd20;
    private view.CustomControl.DatePicker.Button cmd21;
    private view.CustomControl.DatePicker.Button cmd22;
    private view.CustomControl.DatePicker.Button cmd23;
    private view.CustomControl.DatePicker.Button cmd24;
    private view.CustomControl.DatePicker.Button cmd25;
    private view.CustomControl.DatePicker.Button cmd26;
    private view.CustomControl.DatePicker.Button cmd27;
    private view.CustomControl.DatePicker.Button cmd28;
    private view.CustomControl.DatePicker.Button cmd29;
    private view.CustomControl.DatePicker.Button cmd3;
    private view.CustomControl.DatePicker.Button cmd30;
    private view.CustomControl.DatePicker.Button cmd31;
    private view.CustomControl.DatePicker.Button cmd32;
    private view.CustomControl.DatePicker.Button cmd33;
    private view.CustomControl.DatePicker.Button cmd34;
    private view.CustomControl.DatePicker.Button cmd35;
    private view.CustomControl.DatePicker.Button cmd36;
    private view.CustomControl.DatePicker.Button cmd37;
    private view.CustomControl.DatePicker.Button cmd38;
    private view.CustomControl.DatePicker.Button cmd39;
    private view.CustomControl.DatePicker.Button cmd4;
    private view.CustomControl.DatePicker.Button cmd40;
    private view.CustomControl.DatePicker.Button cmd41;
    private view.CustomControl.DatePicker.Button cmd42;
    private view.CustomControl.DatePicker.Button cmd5;
    private view.CustomControl.DatePicker.Button cmd6;
    private view.CustomControl.DatePicker.Button cmd7;
    private view.CustomControl.DatePicker.Button cmd8;
    private view.CustomControl.DatePicker.Button cmd9;
    private view.CustomControl.DatePicker.Button cmdFr;
    private view.CustomControl.DatePicker.Button cmdMo;
    private view.CustomControl.DatePicker.Button cmdSa;
    private view.CustomControl.DatePicker.Button cmdSu;
    private view.CustomControl.DatePicker.Button cmdTh;
    private view.CustomControl.DatePicker.Button cmdTu;
    private view.CustomControl.DatePicker.Button cmdWe;
